...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
        ...
        <header id="cont-header" class="clearfix">
          ...
          <div class="col-md-12">
           <ul class="pull-right hidden-sm hidden-xs">
            <li> <img src="img/logopal.png" width="35" height="40"> </li>
            <li class="hidden-xs welcome">Perpustakaan SMKN 3 Buduran<br> Jl Jenggolo No.1-C, Buduran, Kabupaten Sidoarjo</li>
      ...
      <div id="content">
        <h3 class="title-page"> 
          <span class="glyphicon glyphicon-briefcase glyphicon-title"></span> Anggota Perpustakaan <a href="new-member.html"><button class="btn btn-warning pull-right" style="margin-right: 50px;"><label class="glyphicon glyphicon-plus" style="font-size: 15px;"></label></button></a>
        </h3>
         <hr>
                ...
                ?>
                    <tbody style="color:#a8b9bd; border-color:#95A5A6;" >
                     <tr>
                        ...
                        <td><center><a href="edt-member.php?NO=<?php echo $jadi['NO']; ?>"><button class="btn btn-primary"><label class="glyphicon glyphicon-pencil" style="color:#ECF0F1;"></label></button></center></a></td>
                        <td><center><a href="../php/del-in-member.php?NIS=<?php echo $jadi['NIS']; ?>"><button class="btn btn-danger"><label class="glyphicon glyphicon-trash" style="color:#ECF0F1;"></label></button></center></a></td>
                     </tr>
                    </tbody>
                <?php
                  }
