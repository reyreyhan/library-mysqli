  ...
  <div class="container-fluid display-table">
   <div class="row display-table-row"> 
    ...
    <div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
        <h3 class="title-page"><span class="glyphicon glyphicon-th glyphicon-title"></span> Dashboard</h3>
       <hr>

       <div class="content-inner container-fluid">
       <?php include"php/index-itungan.php" ?>

<div class="row">
    <div class="col-lg-6">
        <div class="kotak">
          <div class="kotak-2">        
            <label class="glyphicon glyphicon-stats glyph-kotak"></label>
            <label class="judul-atas">Jumlah Pengunjung Hari ini (<?php $tgl=date('d-m-Y'); echo "$tgl"; ?>)</label>
            <label class="hasil-hitungan"><?php echo $habsen['absen']; ?></label>
            <label class="detail-label">Orang</label>
          </div>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="kotak">
          <div class="kotak-2">        
            <label class="glyphicon glyphicon-briefcase glyph-kotak"></label>
            <label class="judul-atas">Jumlah Peminjaman Hari ini (<?php $tgl=date('d-m-Y'); echo "$tgl"; ?>)</label>
            <label class="hasil-hitungan"><?php echo $htrans['transaksi']; ?></label>
            <label class="detail-label">Orang</label>
          </div>
        </div>      
    </div>
...
<div class="row">
    <div class="col-lg-6">
        <div class="kotak">
          <div class="kotak-2">        
            <label class="glyphicon glyphicon-book glyph-kotak"></label>
            <label class="judul-atas">Jumlah Koleksi Buku Perpustakaan</label>
            <label class="hasil-hitungan"><?php echo $hdbuk['dat_buk']; ?></label>
            <label class="detail-label" style="margin-right: -135px;">Buku</label>
          </div>
        </div>      
    </div>
    <div class="col-lg-6">
        <div class="kotak">
          <div class="kotak-2">
            <label class="glyphicon glyphicon-user glyph-kotak"></label>
            <label class="judul-atas">Jumlah Anggota Perpustakaan</label>
            <label class="hasil-hitungan"><?php echo $hdang['dat_ang']; ?></label>
            <label class="detail-label" style="margin-right: -165px;">Anggota</label>
          </div>
        </div>      
    </div>
</div>
    <!--div class="col-lg-12 col-md-12 col-sm-12">
           <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#2B2B2B; color:#ecf0f1;">Pengunjung Perpustakaan</div>
             <div class="panel-body">
              <canvas id="linePengunjung" width="600px" height="200px"></canvas>              
             </div>
           </div>
    </div>
    <div class="col-lg-6 col-md-12 col-sm-12">
           <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#2B2B2B; color:#ecf0f1;">Koleksi Buku</div>
             <div class="panel-body">
              <canvas id="pieBuku" height="250px" width="400px"></canvas>            
             </div>
           </div>
    </div>
    <div class="col-lg-6 col-md-12 col-sm-12">
           <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#2B2B2B; color:#ecf0f1;">JK</div>
            <div class="panel-body">
             <canvas id="rdrBuku" height="250px" width="400px"></canvas>
            </div>
           </div>           
    </div-->
