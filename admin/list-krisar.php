...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
         ...
         <h3 class="title-page"><span class="glyphicon glyphicon-comment glyphicon-title"></span> Kritik & Saran Perpustakaan</h3>
         <hr>
               ...
               <table class="table table-hover">
                ...
                ?>
                    <tbody style="color:#a8b9bd; border-color:#95A5A6;" >
                     <tr>
                        <!--td><input name="checkbox[]" type="checkbox"  value="<?php echo $jadi['NO'];?>"/></td--> 
                        <td><?php echo $jadi['NAMA']; ?></td>
                        <td><?php echo $jadi['EMAIL']; ?></td>
                        <td><?php echo $jadi['KOM']; ?></td>
                        <td><center><a href="../php/del-in-krs.php?NO=<?php echo $jadi['NO'];?>"><button class="btn btn-danger"><label class="glyphicon glyphicon-trash" style="color:#ECF0F1;"></label></button></center></a></td>
                     </tr>
                    </tbody>
                <?php
                  }
