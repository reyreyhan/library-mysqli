...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
         <h3 class="title-page"><span class="glyphicon glyphicon-user glyphicon-title"></span> Data Anggota <a href="new-member.php"><button class="btn btn-warning pull-right" style="margin-right:60px;margin-top:11px;"><label class="glyphicon glyphicon-plus" style="font-size:15px;"></label></button></a>
         </h3>
                ...
                <?php while($jadi = mysqli_fetch_array($viewquery)):?>  
                    <tbody style="color:#a8b9bd; border-color:#95A5A6;" >
                     <tr>
                        ...
                        <td><?php echo $jadi['JK']; ?></td>                        
                        <td><?php echo $jadi['JURUSAN']; ?></td>
                        <td><?php echo $jadi['ALAMAT']; ?></td>
                        <td><?php echo $jadi['HP']; ?></td>
                        <td><a href="../edt-member.php?NO=<?php echo $jadi['NO']; ?>"><label class="glyphicon glyphicon-pencil bg-primary" style="padding:10px; border-radius: 5px;"></label></a></td>
                        <td><a href="../php/del-in-member.php?NIS=<?php echo $jadi['NIS']; ?>"><label class="glyphicon glyphicon-trash" style="padding:10px; border-radius:5px;background-color:#e74c3c;color:#ecf0f1;"></label></a></td>
                     </tr>
                    </tbody>
                <?php endwhile; ?>
               </table>
