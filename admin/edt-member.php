...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
         <h3 class="title-page"><span class="glyphicon glyphicon-book glyphicon-title"></span> Edit Data Anggota</h3>
       <hr>
          ...
          <?php 
            ...
            $NO = $_GET ['NO'];
            $view = "SELECT * FROM `anggota` WHERE `NO` = $NO ";
       ...
       <div class="content-inner">
        <div class="row">
         <div class="col-lg-6 col-md-12 col-sm-12">
          ...
          <form method="POST" action="php/edt-in-member.php?NO=<?php echo $jadi['NO']; ?>">

           <div class="form-group">
            <label class="sr-only">Nama</label>
            <input type="text" class="form-control half-width" value="<?php echo $jadi['NAMA']; ?>" name="NAMA" placeholder="Nama" maxlength="35" required>
           </div> 

           <div class="form-group">
            <select data-placeholder="Kelas" name="KELAS" class="form-control sepertiga-width" required>
              <option value="<?php echo $jadi['KELAS'];?>" selected hidden><?php echo $jadi['KELAS']; ?></option>
            ...
            <select data-placeholder="Jenis Kelamin" name="JK" class="form-control sepertiga-width sejajar" required>
              <option value="<?php echo $jadi['JK'];?>" selected hidden><?php echo $jadi['JK']; ?></option>
           ...
           <div class="form-group">
            ...
            <select name="JURUSAN" class="form-control sepertiga-width" required>
              <option value="<?php echo $jadi['JURUSAN'];?>" selected hidden><?php echo $jadi['JURUSAN']; ?></JURUSAN>             
              ...
              <option value="Teknik Instalasi Permesinan Kapal">Teknik Instalasi Permesinan Kapal</option>
            </select>

            <label class="sr-only">NIS</label>
            <input type="text" class="form-control sepertiga-width sejajar" name="NIS" value="<?php echo $jadi['NIS']; ?>" placeholder="NIS Siswa" maxlength="10"  required>
  
            </div>
          
           <div class="form-group">
            <label class="sr-only">Alamat</label>
            <textarea  class="form-control half-width"  name="ALAMAT" placeholder="Alamat" maxlength="100"><?php echo htmlspecialchars($jadi['ALAMAT']); ?></textarea> 
           </div>

           <div class="form-group">
            <label class="sr-only">No HP</label>
            <input type="text" class="form-control half-width" name="HP" value="<?php echo $jadi['HP']; ?>" placeholder="Nomor HP" maxlength="12" required>
           </div>
            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
              <img src="img/nmember.png" style="float:right; width:330px; height:300px; margin-right:40px; margin-top: -20px;" />            
            </div>
          </div> 
         </div>
        </div>
