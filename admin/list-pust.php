...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
         <h3 class="title-page"><span class="glyphicon glyphicon-book glyphicon-title"></span> Data Koleksi Buku <a href="new-pust.php"><button class="btn btn-warning pull-right" style="margin-right:60px;margin-top:11px;"><label class="glyphicon glyphicon-plus" style="font-size:15px;"></label></button></a>
         </h3>
<form action="list-pust.php" method="post">
         <input type="text" class="form-control" name="valueToSearch" style="width:300px;float:right;margin-top:-55px;margin-right: 210px;
" placeholder="Tulis yang ingin dicari...">
          <button class="btn btn-primary" type="submit" style="float:right;margin-top:-55px;margin-right: 130px;" name="search">Search</button>
                ...
                <?php while($jadi = mysqli_fetch_array($viewquery)):?>  
                    <tbody style="color:#a8b9bd; border-color:#95A5A6;" >
                     <tr>
                        ...
                        <td><a href="../edt-pust.php?NO=<?php echo $jadi['NO']; ?>"><label class="glyphicon glyphicon-pencil bg-primary" style="padding:10px; border-radius: 5px;"></label></a></td>
                        <td><a href="../php/del-in-pust.php?NO=<?php echo $jadi['NO']; ?>"><label class="glyphicon glyphicon-trash" style="padding:10px; border-radius:5px;background-color:#e74c3c;color:#ecf0f1;"></label></a></td>
                        <!--td><a href="new-trans.php?NO=<?php echo $jadi['NO']; ?>"><label class="glyphicon glyphicon-hand-up" style="padding:10px; border-radius: 5px;background-color:#2ecc71;color:#ecf0f1;"></label></a></td!--> 
                     </tr>
                    </tbody>
                <?php endwhile; ?>
               </table>
