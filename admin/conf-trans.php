...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
         <h3 class="title-page"><span class="glyphicon glyphicon-list-alt glyphicon-title"></span> Konfirmasi Peminjaman</h3>
       <hr>
       ...
       <!-- <label>Tambah data</label> -->
          ...
          <div class="table-responsive table-scroll">
               <table class="table table-hover">
                ...
                <?php
//                    $view = "SELECT * FROM konfirmasi;";
                  $view = "SELECT konfirmasi.JUDUL, konfirmasi.CODE, anggota.NAMA, konfirmasi.NIS, anggota.ALAMAT, konfirmasi.TGL FROM konfirmasi INNER JOIN anggota ON konfirmasi.NIS=anggota.NIS;";
                ...
                ?>
                    <tbody style="color:#a8b9bd; border-color:#95A5A6;" >
                     <tr>
                        ...
                        <td><center><a href="new-trans.php?CODE=<?php echo $jadi['CODE']; ?>"><button class="btn btn-primary"><label class="glyphicon glyphicon-ok" style="color:#ECF0F1;"></label></button></center></a></td>
                        <td><center><a href="../php/del-in-conf.php?CODE=<?php echo $jadi['CODE']; ?>"><button class="btn btn-danger"><label class="glyphicon glyphicon-remove" style="color:#ECF0F1;"></label></button></center></a></td>
                     </tr>
                    </tbody>
                <?php
                  }
