...
<div class="col-md-10 col-sm-11 display-table-cell valign-top">
      ...
      <div id="content">
         <h3 class="title-page">
          <span class="glyphicon glyphicon-briefcase glyphicon-title"></span> Daftar Transaksi <a href="conf-trans.php"><button class="btn btn-warning pull-right" style="margin-right: 50px;"><label class="glyphicon glyphicon-plus" style="font-size: 15px;"></label></button></a>
         </h3>
       <hr>
       ...
       <!-- <label>Tambah data</label> -->
          ...
          <div class="table-responsive table-scroll">
               <table class="table table-hover">
                ...
                <?php
                  $view = "SELECT pinjam.NO, pinjam.CODE, pinjam.JUDUL, anggota.NAMA, 
                           pinjam.NIS, anggota.HP, anggota.ALAMAT, pinjam.TGL FROM pinjam INNER JOIN anggota ON pinjam.NIS=anggota.NIS;";
                ...
                ?>
                    <tbody style="color:#a8b9bd; border-color:#95A5A6;" >
                     <tr>
                        ...
                        <td><center><a href="cekdenda.php?NO=<?php echo $jadi['NO']; ?>&NIS=<?php echo $jadi['NIS']; ?>"><button class="btn btn-primary"><label class="glyphicon glyphicon-ok" style="color:#ECF0F1;"></label></button></center></a></td>
                     </tr>
                    </tbody>
                <?php
                  }
