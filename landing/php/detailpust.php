...
<!--      <div class="container-fluid primary-bg text-center">
      ...
      <div class="container-fluid content text-center">
        ...
        <div class="row">
          <a href="#" class="set-glyph"><span class="fa fa-book fa-5x" style="margin-top:20px;"></span></a>
            <h4 class="">Detail Koleksi Buku.</h4><br>
          </div>
            ...
            <div class="content-menu">
                ...
                <div class="col-lg-6" style="margin-top:-20px;">      
                   ...
                   <div class="form-group">
                      <label class="pull-left">Judul Buku</label>
                   ...
                   <div class="form-group">
                     <label class="pull-left">Review</label>
                      <textarea readonly class="form-control half-width" name="KATEGORI" placeholder="Sinopsis Buku" maxlength="60" required><?php echo $jadi['SINOPSIS']; ?></textarea>
                   </div>

                   <div class="form-group">
                    <label class="pull-left">Keterangan</label> <br>
                    <table class="pull-left" style="text-align: left; margin-left: -50px; margin-top: 10px;">
                      <tr>
                      ...
                      <tr>
                        ...
                        <td style="padding-left: 10px;">:</td>
                        <td><?php echo $jadi['PENERBIT']; ?></td>
                      </tr>
                      <tr>
                        <td><li>Pengarang</li></td>
                        <td style="padding-left: 10px;">:</td>
                        <td><?php echo $jadi['PENGARANG']; ?></td>
                      </tr>
                      <tr>
                        <td><li>Tahun Terbit</li></td>
                        <td style="padding-right: 20px; padding-left: 10px;">:</td>
                        <td> <?php echo $jadi['TAHUN']; ?></td>
                      </tr>
                      <tr>
                        <td><li>Kode Buku</li></td>
                        <td style="padding-right: 20px; padding-left: 10px;">:</td>
                    ...
                    <div class="form-group">
                    <a href="../kobuk.php"><button type="link" class="btn btn-success" style="margin-top: 90px;">Kembali</button></a>   
                    <a href="new-trans.php?NO=<?php echo $jadi['NO']; ?>"><button type="submit" class="btn btn-primary" style="margin-top: 90px;">Pinjam</button></a>   
                    </div>
                      
                </div>

                <div class="col-lg-3"></div>
            </div class="#div'e-content">
        </div>
  </body class="body-ndukur dewe">
